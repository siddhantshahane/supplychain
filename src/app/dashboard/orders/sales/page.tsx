...
const customers = [
  { id: 1, name: "Acme Corporation", type: "Enterprise", rating: 4.5 },
  { id: 2, name: "Tech Solutions Ltd", type: "Mid-Market", rating: 4.2 },
  { id: 3, name: "Global Industries", type: "Enterprise", rating: 4.8 },
  { id: 4, name: "Innovation Systems", type: "SMB", rating: 4.0 },
  { id: 5, name: "Future Tech Inc", type: "Mid-Market", rating: 4.6 }
];
...
const salesStats = {
  ...
  averageOrderValue: 1872.45,
  conversionRate: 68,
  topCustomers: [
    { name: "Acme Corporation", spend: 125000.00 },
    { name: "Tech Solutions Ltd", spend: 98000.00 },
    { name: "Global Industries", spend: 75000.00 }
  ]
};
    ...
    <div className="container mx-auto px-4 py-6 space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="shadow-sm">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              {salesStats.pendingOrders} pending orders
            </p>
          </CardContent>
        </Card>
        <Card className="shadow-sm">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Avg. ${salesStats.averageOrderValue.toLocaleString()} per order
            </p>
          </CardContent>
        </Card>
        <Card className="shadow-sm">
        ...
        <Card className="shadow-sm">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              ${salesStats.topCustomers[0].spend.toLocaleString()}
            </div>
            <p className="text-xs text-muted-foreground mt-1">
              {salesStats.topCustomers[0].name}
            </p>
          </CardContent>
        </Card>
      </div>
